 ...
 * Purpose: Định nghĩa các hằng số cấu hình dùng chung toàn hệ thống
 * (đường dẫn thư mục, timezone, session, quy tắc nghiệp vụ cấp hệ thống...).
 *
 * File này PHẢI được include đầu tiên (trước database.php) ở entry point,
 * vì nó thiết lập timezone và session trước khi bất kỳ logic nào chạy.
 */
