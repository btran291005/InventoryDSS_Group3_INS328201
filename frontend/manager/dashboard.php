 ...
 * Sẽ được thay thế bằng bản đầy đủ ở Phase 6 (ManagerService::getDashboardData()).
 * Related: FR-MGR-01
 */
...
// BR-19 / NFR-03: chỉ Manager được vào trang này, chặn ở tầng server
...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #dcfce7; color: #166534; font-size: 12px; font-weight: 600; padding: 4px 10px; border-radius: 999px; margin-bottom: 16px; }
...
<body>
    <div class="box">
        ...
        <div class="stub-note">
            ...
            Dashboard đầy đủ (inventory, sales, low-stock alert, reorder suggestion...) sẽ được xây ở Phase 6 theo FR-MGR-01 → FR-MGR-12.
        </div>
