        ...
        <div class="app-content">
            ...
            <main class="app-main">
                ...
                <div class="mb-4">
                    ...
                    <p class="page-subheading mb-0">Ghi nhận phản hồi/khiếu nại của khách hàng liên quan tới hết hàng (FR-STF-11).</p>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-12 col-xl-4">
                        <div class="panel-card">
                            <div class="panel-card-header">
                                <h3 class="panel-card-title">Ghi nhận phản hồi mới</h3>
                            </div>
                            <form method="POST" class="d-flex flex-column gap-3">
                                <div>
                                    <label class="form-label small">Sản phẩm liên quan (tùy chọn)</label>
                                ...
                                <div>
                                    ...
                                    <textarea name="feedback_text" class="form-control" rows="4" required placeholder="VD: Khách phàn nàn hết sữa tươi không đường..."></textarea>
                                </div>
                                <button type="submit" class="btn btn-brand btn-sm">Ghi nhận phản hồi</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="panel-card">
                            <div class="panel-card-header">
                                <h3 class="panel-card-title">Lịch sử phản hồi</h3>
                                <span class="panel-card-note"><?= count($feedbackList) ?> phản hồi</span>
                            </div>

                            <?php if (empty($feedbackList)): ?>
                                <div class="empty-state">Chưa có phản hồi nào được ghi nhận.</div>
                            <?php else: ?>
